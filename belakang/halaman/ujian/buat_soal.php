...
$ujian_exe = mysql_query("select nama_ujian,id_pelajaran from ujian where id_ujian='".$id_ujian."'");
...
function simpan(elm){
  ...
  var url = "halaman/ujian/simpan_soal.php";
...
function kembali_lagi(id_pelajaran){
  $("#content").html(info_loading).load("daftar_ujian.php?id_pelajaran="+id_pelajaran);
  }           
$(function(){
  $("#t_soal").click();
})  
